        ...
        try {
            ...
            foreach ($akAdCostData['records'] as $item) {
                ...
                $addData[] = [
                    ...
                    'fbaStorageFee'                             =>  $item['fbaStorageFee'],
                    'sharedFbaStorageFee'                       =>  $item['sharedFbaStorageFee'],
                    'longTermStorageFee'                        =>  $item['longTermStorageFee'],
                    'sharedFbaDisposalFee'                      =>  $item['sharedFbaDisposalFee'],
                    'sharedLabelingFee'                         =>  $item['sharedLabelingFee'],
                    'sharedFbaInboundDefectFee'                 =>  $item['sharedFbaInboundDefectFee'],
                    'sharedTapingFee'                           =>  $item['sharedTapingFee'],
                    'sharedItemFeeAdjustment'                   =>  $item['sharedItemFeeAdjustment'],
                    'sharedStorageRenewalBilling'               =>  $item['sharedStorageRenewalBilling'],
                    'sharedBubblewrapFee'                       =>  $item['sharedBubblewrapFee'],
                    'sharedOtherFbaInventoryFees'               =>  $item['sharedOtherFbaInventoryFees'],
                    'sharedFbaInboundTransportationProgramFee'  =>  $item['sharedFbaInboundTransportationProgramFee'],
                    'sharedPolybaggingFee'                      =>  $item['sharedPolybaggingFee'],
                    'sharedFbaCustomerReturnFee'                =>  $item['sharedFbaCustomerReturnFee'],
                    'sharedFbaRemovalFee'                       =>  $item['sharedFbaRemovalFee'],
                    'sharedAmazonPartneredCarrierShipmentFee'   =>  $item['sharedAmazonPartneredCarrierShipmentFee'],
                    'sharedFbaInboundConvenienceFee'            =>  $item['sharedFbaInboundConvenienceFee'],
