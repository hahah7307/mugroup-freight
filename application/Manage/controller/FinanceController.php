...
class FinanceController extends BaseController
{
    ...
    public function report_export()
    {
        ...
        $financeExcelInit->generateFbaSheet(1, $report_id, $report['month']);
        $financeExcelInit->generateFbmSheet(2, $report_id, $report['month']);
        $financeExcelInit->generateWalmartSheet(3, $report_id);
        $financeExcelInit->generateWayfairSheet(4, $report_id);
        $financeExcelInit->generateSheinSheet(5, $report_id);
        $financeExcelInit->generateTemuSheet(6, $report_id);
        $financeExcelInit->generateEbaySheet(7, $report_id);
        $financeExcelInit->generatePaymentNoOutboundSheet(8, $report_id);
