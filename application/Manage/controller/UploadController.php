...
class UploadController extends Controller
{
    ...
    public function finance_order_upload()
    {
        ...
        if (!in_array($payment_type, ['amazon_us', 'amazon_uk', 'amazon_de', 'amazon_es', 'amazon_fr', 'amazon_it', 'wayfair', 'walmart', 'shein', 'shein_semi_managed', 'temu', 'temu_detail', 'ebay', 'wildberries'])) {
