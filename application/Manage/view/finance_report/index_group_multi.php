...
<style>
    ...
    .main_style {height:450px; width: 2000px}
        ...
        <div class="layui-tab" lay-filter="testTab">
            ...
            <div class="layui-tab-content">
                ...
                <div class="layui-tab-item">
                    ...
                    <div class="layui-form pie-chart2">
                        <div id="main_10" class="main_style"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    layui.use(['form', 'jquery', 'laydate', 'element'], function(){
        ...
        let select = xmSelect.render({
            ...
            remoteMethod: function(val, cb) {
                // val 是输入值
                // cb 是回调函数，用于返回数据
                $.get("{:url('Check/get_group_name_origin_multi')}", {search: val, selected: "{$group_name}"}, function(res){
        ...
        category_1.setOption({
            title: {
                text: '年度财报利润额柱状图（单位：美金）',
                left: 'center'
            },
            tooltip: {
                trigger: 'axis'   // 饼图用 item，折线柱状图可用 axis
            },
            legend: {
                top: 0,
                right: 0,
