...
<div class="layui-body" id="LAY_app_body">
    <div class="right">
        ...
        <div class="title">添加产品组</div>
        <div class="layui-form">
            <div class="layui-form-item">
                <label class="layui-form-label">产品组名称</label>
                <div class="layui-input-inline w300">
                    <input type="text" class="layui-input" name="group_name" placeholder="请填写产品组名称">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">短描述</label>
                <div class="layui-input-inline w300">
                    <input type="text" class="layui-input" name="desc" placeholder="请填写短描述">
                </div>
            </div>
            <div class="layui-form-item">
...
<script>
    layui.use(['form', 'jquery'], function(){
        ...
        form.on('submit(formCoding)', function(data){
            ...
            button.text('请稍候...');
            axios.post("{:url('group_add')}", data.field)
