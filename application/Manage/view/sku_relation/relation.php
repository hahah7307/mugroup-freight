...
<div class="layui-body" id="LAY_app_body">
    <div class="right">
        ...
        <div class="layui-form">
            <a class="layui-btn" href="{:url('relation_add',  ['id' => $id])}">添加</a>
            <table class="layui-table" lay-size="sm">
                ...
                <tr>
                    <td>{$v.id}</td>
                    <td>{$v.pcr_product_sku}</td>
                    <td class="tr">{$v.pcr_quantity}</td>
                    <td class="tr">{$v.pcr_percent}</td>
                    <td>{$v.pcr_update_time}</td>
                    <td class="tc">
