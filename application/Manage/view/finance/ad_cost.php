...
<div class="layui-body" id="LAY_app_body">
    <div class="right">
        ...
        <div class="layui-form">
            ...
            <span class="total">广告费合计：{$ad_cost|number_format=###,2}</span>
    ...
    layui.use(['form', 'jquery', 'upload', 'laydate'], function(){
        ...
        let uploadInst = upload.render({
            ...
            ,done: function(res){
                //上传完毕回调
                if (res.code === 1) {
                    location.href = "/Manage/Finance/ad_cost_import/id/{$report_id}/filename/" + res.data + "/origin/" + res.origin;
                } else {
        ...
        form.on('submit(Detele)', function(data){
            ...
            layer.confirm('确定清空列表吗？',{icon:3,closeBtn:0,title:false,btnAlign:'c'},function(){
                ...
                button.text('请稍候...');
                axios.post("{:url('ad_cost_empty')}", {id:id})
