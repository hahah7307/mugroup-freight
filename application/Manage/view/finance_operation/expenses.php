...
<div class="layui-body" id="LAY_app_body">
    <div class="right">
        ...
        <div class="layui-form">
            ...
            <a href="{:url('expenses_export')}" class="layui-btn layui-btn-normal">导出</a>
    ...
    layui.use(['form', 'jquery', 'upload', 'laydate'], function(){
        ...
        let uploadInst = upload.render({
            ...
            ,done: function(res){
                //上传完毕回调
                if (res.code === 1) {
                    location.href = "/Manage/FinanceOperation/expenses_import/filename/" + res.data + "/origin/" + res.origin;
                } else {
        ...
        form.on('submit(Detele)', function(data){
            ...
            layer.confirm('确定删除吗？',{icon:3,closeBtn:0,title:false,btnAlign:'c'},function(){
                ...
                button.text('请稍候...');
                axios.post("{:url('expenses_delete')}", {id:id})
