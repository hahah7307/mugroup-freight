    ...
    <div class="right">
		...
		<div class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline w300">
                    <input type="text" class="layui-input" name="lbs_weight" value="{$info.lbs_weight}">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">体积重（kg）</label>
                <div class="layui-input-inline w300">
                    <input type="text" class="layui-input" name="kg_weight" value="{$info.kg_weight}">
                </div>
            </div>
            <div class="layui-form-item">
