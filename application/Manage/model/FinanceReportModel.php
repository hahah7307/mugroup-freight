	...
	FROM
		...
		FROM
			...
			SELECT
				...
				NULL AS fba_sale_selling_fees,
				ROUND( selling_fees * c.percent, 7 ) fba_refund_selling_fees,
				NULL AS fba_fees,
				ROUND( fba_fees * c.percent, 7 ) fba_refund_fees,
	...
	FROM
		...
		FROM
			...
			SELECT
				...
				NULL AS fbm_sale_selling_fees,
				ROUND( selling_fees * c.percent, 7 ) fbm_refund_selling_fees,
