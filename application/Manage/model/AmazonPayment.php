        ...
        foreach ($excel as $item) {
            ...
            if ($item[11] == '订单销售收入-订单收入') {
                $this->orderSaleNew[] = [
                    ...
                    "quantity"                  =>  $item[7],
                    "fulfillment"               =>  "Seller",
                    "product_sales"             =>  FinanceOrderSaleModel::sheinNumberFormat($item[12]),
                    "selling_fees"              =>  FinanceOrderSaleModel::sheinNumberFormat($item[16]),
                    "shipping_credits"          =>  0,
                    "gift_wrap_credits"         =>  0,
                    "regulatory_fee"            =>  0,
                    "promotional_rebates"       =>  0,
            ...
            } elseif ($item[11] == '平台服务费-退货单履约服务费'
                || $item[11] == '奖惩及其他-违规撤销补款'
                || $item[11] == '奖惩及其他-违规处罚扣款'
                || $item[11] == '奖惩及其他-违规撤销资金解冻'
                || $item[11] == '奖惩及其他-违规处罚资金冻结'
            ) {
                $this->orderAdjustmentNew[] = [
                    "report_id"                 =>  $reportId,
                    "table_id"                  =>  $tableId,
                    "payment_id"                =>  $item[1],
                    "total"                     =>  FinanceOrderSaleModel::sheinNumberFormat($item[20]),
                ];
            }
        }
