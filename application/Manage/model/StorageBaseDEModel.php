...
class StorageBaseDEModel extends Model
{
    const STATE_ACTIVE = 1;

    protected $name = 'storage_base_de';
     ...
     * @throws DbException
     */
    static public function getBaseDE($storage, $order, $detail)
    {
