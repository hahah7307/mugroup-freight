...
class FinanceExcelInit extends Model
{
    ...
    public function generateFbmSheet($index, $report_id, $month)
    {
        ...
        $this->objPHPExcel->setActiveSheetIndex($index)
            ...
            ->setCellValue('Z1', '无忧达调整')
            ->setCellValue('AA1', '平台广告费')
            ->setCellValue('AB1', '国内广告费')
            ->setCellValue('AC1', '工厂运费')
            ->setCellValue('AD1', '国内快递费')
            ->setCellValue('AE1', '产品DDP总值')
            ->setCellValue('AF1', 'DDP占比')
            ->setCellValue('AG1', '毛利')
            ->setCellValue('AH1', '毛利率')
            ->setCellValue('AI1', '广告费占比')
            ->setCellValue('AJ1', '仓储费占比')
            ->setCellValue('AK1', '尾程占比')
            ->setCellValue('AL1', '测评数量')
            ->setCellValue('AM1', '测评金额')
            ->setCellValue('AN1', '含测评毛利')
            ->setCellValue('AO1', '含测评毛利率')
        ;
        ...
        foreach ($fbmWarehouseSku as $fbmItem) {
            ...
            $this->objPHPExcel->setActiveSheetIndex($index)
                ...
                ->setCellValue('Z' . $fbmIndex, $fbmItem['wyd_adjustment'])
                ->setCellValue('AA' . $fbmIndex, $fbmItem['fbm_adCost'])
                ->setCellValue('AB' . $fbmIndex, $fbmItem['operation_expenses'])
                ->setCellValue('AC' . $fbmIndex, $fbmItem['operation_factory'])
                ->setCellValue('AD' . $fbmIndex, $fbmItem['operation_delivery'])
                ->setCellValue('AE' . $fbmIndex, $fbmItem['fbm_ddp'])
                ->setCellValue('AF' . $fbmIndex, $fbmItem['ddp_percent'])
                ->setCellValue('AG' . $fbmIndex, $fbmItem['profit'])
                ->setCellValue('AH' . $fbmIndex, $fbmItem['gross_profit_margin'])
                ->setCellValue('AI' . $fbmIndex, $fbmItem['ad_percent'])
                ->setCellValue('AJ' . $fbmIndex, $fbmItem['inventory_percent'])
                ->setCellValue('AK' . $fbmIndex, $fbmItem['tail_percent'])
                ->setCellValue('AL' . $fbmIndex, $fbmItem['evaluation_qty'])
                ->setCellValue('AM' . $fbmIndex, $fbmItem['evaluation_amount'])
                ->setCellValue('AN' . $fbmIndex, $fbmItem['profit_include_evaluation'])
                ->setCellValue('AO' . $fbmIndex, $fbmItem['gross_profit_margin_include_evaluation'])
            ;
        }
    }
    ...
    public function generateWalmartSheet($index, $report_id, $month)
    {
        ...
        foreach ($walmartWarehouseSku as $walmartItem) {
            ...
            $this->objPHPExcel->setActiveSheetIndex($index)
                ...
                ->setCellValue('X' . $walmartIndex, $walmartItem['wyd_adjustment'])
                ->setCellValue('Y' . $walmartIndex, $walmartItem['adCost'])
                ->setCellValue('Z' . $walmartIndex, $walmartItem['operation_expenses'])
                ->setCellValue('AA' . $walmartIndex, $walmartItem['operation_factory'])
                ->setCellValue('AB' . $walmartIndex, $walmartItem['operation_delivery'])
                ->setCellValue('AC' . $walmartIndex, $walmartItem['ddp'])
                ->setCellValue('AD' . $walmartIndex, $walmartItem['ddp_percent'])
                ->setCellValue('AE' . $walmartIndex, $walmartItem['profit'])
                ->setCellValue('AF' . $walmartIndex, $walmartItem['gross_profit_margin'])
                ->setCellValue('AG' . $walmartIndex, $walmartItem['ad_percent'])
                ->setCellValue('AH' . $walmartIndex, $walmartItem['warehouse_percent'])
                ->setCellValue('AI' . $walmartIndex, $walmartItem['tail_percent'])
                ->setCellValue('AJ' . $walmartIndex, $walmartItem['evaluation_qty'])
                ->setCellValue('AK' . $walmartIndex, $walmartItem['evaluation_amount'])
                ->setCellValue('AL' . $walmartIndex, $walmartItem['profit_include_evaluation'])
                ->setCellValue('AM' . $walmartIndex, $walmartItem['gross_profit_margin_include_evaluation'])
            ;
        }
    }
    ...
    public function generateWayfairSheet($index, $report_id, $month)
    {
        ...
        foreach ($wayfairWarehouseSku as $wayfairItem) {
            ...
            $this->objPHPExcel->setActiveSheetIndex($index)
                ...
                ->setCellValue('T' . $wayfairIndex, $wayfairItem['wyd_adjustment'])
                ->setCellValue('U' . $wayfairIndex, $wayfairItem['adCost'])
                ->setCellValue('V' . $wayfairIndex, $wayfairItem['operation_expenses'])
                ->setCellValue('W' . $wayfairIndex, $wayfairItem['operation_factory'])
                ->setCellValue('X' . $wayfairIndex, $wayfairItem['operation_delivery'])
                ->setCellValue('Y' . $wayfairIndex, $wayfairItem['ddp'])
                ->setCellValue('Z' . $wayfairIndex, $wayfairItem['ddp_percent'])
                ->setCellValue('AA' . $wayfairIndex, $wayfairItem['profit'])
                ->setCellValue('AB' . $wayfairIndex, $wayfairItem['gross_profit_margin'])
                ->setCellValue('AC' . $wayfairIndex, $wayfairItem['ad_percent'])
                ->setCellValue('AD' . $wayfairIndex, $wayfairItem['warehouse_percent'])
                ->setCellValue('AE' . $wayfairIndex, $wayfairItem['tail_percent'])
                ->setCellValue('AF' . $wayfairIndex, $wayfairItem['evaluation_qty'])
                ->setCellValue('AG' . $wayfairIndex, $wayfairItem['evaluation_amount'])
                ->setCellValue('AH' . $wayfairIndex, $wayfairItem['profit_include_evaluation'])
                ->setCellValue('AI' . $wayfairIndex, $wayfairItem['gross_profit_margin_include_evaluation'])
            ;
        }
    }
    ...
    public function generateTemuSheet($index, $report_id, $month)
    {
        ...
        foreach ($temuWarehouseSku as $temuItem) {
            ...
            $this->objPHPExcel->setActiveSheetIndex($index)
                ...
                ->setCellValue('U' . $temuIndex, $temuItem['wyd_adjustment'])
                ->setCellValue('V' . $temuIndex, $temuItem['adCost'])
                ->setCellValue('W' . $temuIndex, $temuItem['operation_expenses'])
                ->setCellValue('X' . $temuIndex, $temuItem['operation_factory'])
                ->setCellValue('Y' . $temuIndex, $temuItem['operation_delivery'])
                ->setCellValue('Z' . $temuIndex, $temuItem['ddp'])
                ->setCellValue('AA' . $temuIndex, $temuItem['ddp_percent'])
                ->setCellValue('AB' . $temuIndex, $temuItem['profit'])
                ->setCellValue('AC' . $temuIndex, $temuItem['gross_profit_margin'])
                ->setCellValue('AD' . $temuIndex, $temuItem['ad_percent'])
                ->setCellValue('AE' . $temuIndex, $temuItem['warehouse_percent'])
                ->setCellValue('AF' . $temuIndex, $temuItem['tail_percent'])
                ->setCellValue('AG' . $temuIndex, $temuItem['evaluation_qty'])
                ->setCellValue('AH' . $temuIndex, $temuItem['evaluation_amount'])
                ->setCellValue('AI' . $temuIndex, $temuItem['profit_include_evaluation'])
                ->setCellValue('AJ' . $temuIndex, $temuItem['gross_profit_margin_include_evaluation'])
            ;
        }
    }
    ...
    public function generateEbaySheet($index, $report_id, $month)
    {
        ...
        foreach ($ebayWarehouseSku as $ebayItem) {
            ...
            $this->objPHPExcel->setActiveSheetIndex($index)
                ...
                ->setCellValue('U' . $ebayIndex, $ebayItem['wyd_adjustment'])
                ->setCellValue('V' . $ebayIndex, $ebayItem['adCost'])
                ->setCellValue('W' . $ebayIndex, $ebayItem['operation_expenses'])
                ->setCellValue('X' . $ebayIndex, $ebayItem['operation_factory'])
                ->setCellValue('Y' . $ebayIndex, $ebayItem['operation_delivery'])
                ->setCellValue('Z' . $ebayIndex, $ebayItem['ddp'])
                ->setCellValue('AA' . $ebayIndex, $ebayItem['ddp_percent'])
                ->setCellValue('AB' . $ebayIndex, $ebayItem['profit'])
                ->setCellValue('AC' . $ebayIndex, $ebayItem['gross_profit_margin'])
                ->setCellValue('AD' . $ebayIndex, $ebayItem['ad_percent'])
                ->setCellValue('AE' . $ebayIndex, $ebayItem['warehouse_percent'])
                ->setCellValue('AF' . $ebayIndex, $ebayItem['tail_percent'])
                ->setCellValue('AG' . $ebayIndex, $ebayItem['evaluation_qty'])
                ->setCellValue('AH' . $ebayIndex, $ebayItem['evaluation_amount'])
                ->setCellValue('AI' . $ebayIndex, $ebayItem['profit_include_evaluation'])
                ->setCellValue('AJ' . $ebayIndex, $ebayItem['gross_profit_margin_include_evaluation'])
            ;
        }
    }
    ...
    public function generateSheinSheet($index, $report_id, $month)
    {
        ...
        foreach ($sheinWarehouseSku as $sheinItem) {
            ...
            $this->objPHPExcel->setActiveSheetIndex($index)
                ...
                ->setCellValue('T' . $sheinIndex, $sheinItem['wyd_adjustment'])
                ->setCellValue('U' . $sheinIndex, $sheinItem['adCost'])
                ->setCellValue('V' . $sheinIndex, $sheinItem['operation_expenses'])
                ->setCellValue('W' . $sheinIndex, $sheinItem['operation_factory'])
                ->setCellValue('X' . $sheinIndex, $sheinItem['operation_delivery'])
                ->setCellValue('Y' . $sheinIndex, $sheinItem['ddp'])
                ->setCellValue('Z' . $sheinIndex, $sheinItem['ddp_percent'])
                ->setCellValue('AA' . $sheinIndex, $sheinItem['profit'])
                ->setCellValue('AB' . $sheinIndex, $sheinItem['gross_profit_margin'])
                ->setCellValue('AC' . $sheinIndex, $sheinItem['ad_percent'])
                ->setCellValue('AD' . $sheinIndex, $sheinItem['warehouse_percent'])
                ->setCellValue('AE' . $sheinIndex, $sheinItem['tail_percent'])
                ->setCellValue('AF' . $sheinIndex, $sheinItem['evaluation_qty'])
                ->setCellValue('AG' . $sheinIndex, $sheinItem['evaluation_amount'])
                ->setCellValue('AH' . $sheinIndex, $sheinItem['profit_include_evaluation'])
                ->setCellValue('AI' . $sheinIndex, $sheinItem['gross_profit_margin_include_evaluation'])
            ;
        }
    }
    ...
    public function generateTiktokWarehouseSkuSql($index, $report, $month)
    {
        ...
        $this->objPHPExcel->setActiveSheetIndex($index)
            ...
            ->setCellValue('O1', '平台佣金退款')
            ->setCellValue('P1', '调整费用')
            ->setCellValue('Q1', '平台运费')
            ->setCellValue('R1', 'FBM尾程')
            ->setCellValue('S1', '海外仓仓储费')
            ->setCellValue('T1', '良仓调整')
            ->setCellValue('U1', '乐歌调整')
            ->setCellValue('V1', '无忧达调整')
        ...
        foreach ($tiktok as $tiktokItem) {
            ...
            $this->objPHPExcel->setActiveSheetIndex($index)
                ...
                ->setCellValue('P' . $tiktokIndex, $tiktokItem['adjustment'])
                ->setCellValue('Q' . $tiktokIndex, $tiktokItem['fba_fee'])
                ->setCellValue('R' . $tiktokIndex, $tiktokItem['calcuRes'])
                ->setCellValue('S' . $tiktokIndex, $tiktokItem['warehouse_rent'])
                ->setCellValue('T' . $tiktokIndex, $tiktokItem['lc_adjustment'])
                ->setCellValue('U' . $tiktokIndex, $tiktokItem['le_adjustment'])
                ->setCellValue('V' . $tiktokIndex, $tiktokItem['wyd_adjustment'])
                ->setCellValue('W' . $tiktokIndex, $tiktokItem['adCost'])
                ->setCellValue('X' . $tiktokIndex, $tiktokItem['operation_expenses'])
                ->setCellValue('Y' . $tiktokIndex, $tiktokItem['operation_factory'])
                ->setCellValue('Z' . $tiktokIndex, $tiktokItem['operation_delivery'])
                ->setCellValue('AA' . $tiktokIndex, $tiktokItem['ddp'])
                ->setCellValue('AB' . $tiktokIndex, $tiktokItem['ddp_percent'])
                ->setCellValue('AC' . $tiktokIndex, $tiktokItem['profit'])
                ->setCellValue('AD' . $tiktokIndex, $tiktokItem['gross_profit_margin'])
                ->setCellValue('AE' . $tiktokIndex, $tiktokItem['ad_percent'])
                ->setCellValue('AF' . $tiktokIndex, $tiktokItem['warehouse_percent'])
                ->setCellValue('AG' . $tiktokIndex, $tiktokItem['tail_percent'])
                ->setCellValue('AH' . $tiktokIndex, $tiktokItem['evaluation_qty'])
                ->setCellValue('AI' . $tiktokIndex, $tiktokItem['evaluation_amount'])
                ->setCellValue('AJ' . $tiktokIndex, $tiktokItem['profit_include_evaluation'])
                ->setCellValue('AK' . $tiktokIndex, $tiktokItem['gross_profit_margin_include_evaluation'])
            ;
        }
    }
    ...
    public function getHomeDepotWarehouseSkuSql($index, $report, $month)
    {
        ...
        foreach ($tiktok as $homedepotItem) {
            ...
            $this->objPHPExcel->setActiveSheetIndex($index)
                ...
                ->setCellValue('R' . $homedepotIndex, $homedepotItem['waybill'])
                ->setCellValue('S' . $homedepotIndex, $homedepotItem['warehouse_rent'])
                ->setCellValue('T' . $homedepotIndex, $homedepotItem['lc_adjustment'])
                ->setCellValue('U' . $homedepotIndex, $homedepotItem['le_adjustment'])
                ->setCellValue('V' . $homedepotIndex, $homedepotItem['wyd_adjustment'])
                ->setCellValue('W' . $homedepotIndex, $homedepotItem['adCost'])
                ->setCellValue('X' . $homedepotIndex, $homedepotItem['operation_expenses'])
                ->setCellValue('Y' . $homedepotIndex, $homedepotItem['operation_factory'])
                ->setCellValue('Z' . $homedepotIndex, $homedepotItem['operation_delivery'])
                ->setCellValue('AA' . $homedepotIndex, $homedepotItem['ddp'])
                ->setCellValue('AB' . $homedepotIndex, $homedepotItem['ddp_percent'])
                ->setCellValue('AC' . $homedepotIndex, $homedepotItem['profit'])
                ->setCellValue('AD' . $homedepotIndex, $homedepotItem['gross_profit_margin'])
                ->setCellValue('AE' . $homedepotIndex, $homedepotItem['ad_percent'])
                ->setCellValue('AF' . $homedepotIndex, $homedepotItem['warehouse_percent'])
                ->setCellValue('AG' . $homedepotIndex, $homedepotItem['tail_percent'])
                ->setCellValue('AH' . $homedepotIndex, $homedepotItem['evaluation_qty'])
                ->setCellValue('AI' . $homedepotIndex, $homedepotItem['evaluation_amount'])
                ->setCellValue('AJ' . $homedepotIndex, $homedepotItem['profit_include_evaluation'])
                ->setCellValue('AK' . $homedepotIndex, $homedepotItem['gross_profit_margin_include_evaluation'])
            ;
        }
    }
