...
class FinanceExcelInit extends Model
{
    ...
    public function generateTemuSheet($index, $report_id, $month)
    {
        ...
        foreach ($temuWarehouseSku as $temuItem) {
            ...
            $this->objPHPExcel->setActiveSheetIndex($index)
                ...
                ->setCellValue('Q' . $temuIndex, $temuItem['warehouse_rent'])
                ->setCellValue('R' . $temuIndex, $temuItem['lc_adjustment'])
                ->setCellValue('S' . $temuIndex, $temuItem['le_adjustment'])
                ->setCellValue('T' . $temuIndex, $temuItem['adCost'])
                ->setCellValue('U' . $temuIndex, $temuItem['operation_expenses'])
                ->setCellValue('V' . $temuIndex, $temuItem['operation_factory'])
                ->setCellValue('W' . $temuIndex, $temuItem['operation_delivery'])
                ->setCellValue('X' . $temuIndex, $temuItem['ddp'])
                ->setCellValue('Y' . $temuIndex, $temuItem['ddp_percent'])
                ->setCellValue('Z' . $temuIndex, $temuItem['profit'])
                ->setCellValue('AA' . $temuIndex, $temuItem['gross_profit_margin'])
                ->setCellValue('AB' . $temuIndex, $temuItem['ad_percent'])
                ->setCellValue('AC' . $temuIndex, $temuItem['warehouse_percent'])
                ->setCellValue('AD' . $temuIndex, $temuItem['tail_percent'])
                ->setCellValue('AE' . $temuIndex, $temuItem['evaluation_qty'])
                ->setCellValue('AF' . $temuIndex, $temuItem['evaluation_amount'])
                ->setCellValue('AG' . $temuIndex, $temuItem['profit_include_evaluation'])
                ->setCellValue('AH' . $temuIndex, $temuItem['gross_profit_margin_include_evaluation'])
            ;
        }
    }
    ...
    public function getWildberriesWarehouseSkuSql($index, $report)
    {
        ...
        $this->objPHPExcel->setActiveSheetIndex($index)
            ...
            ->setCellValue('O1', '回款金额')
            ->setCellValue('P1', '退款回款金额')
            ->setCellValue('Q1', '平台运费')
            ->setCellValue('R1', '成本合计')
            ->setCellValue('S1', '国内运费')
            ->setCellValue('T1', '调整费用')
            ->setCellValue('U1', '毛利')
            ->setCellValue('V1', '毛利率')
        ;
        ...
        foreach ($wildberries as $wildberriesItem) {
            ...
            $this->objPHPExcel->setActiveSheetIndex($index)
                ...
                ->setCellValue('H' . $wildberriesIndex, $wildberriesItem['refund_qty'])
                ...
                ->setCellValue('O' . $wildberriesIndex, $wildberriesItem['sale_total'])
                ->setCellValue('P' . $wildberriesIndex, $wildberriesItem['refund_total'])
                ->setCellValue('Q' . $wildberriesIndex, $wildberriesItem['shipping_fee'])
                ->setCellValue('R' . $wildberriesIndex, $wildberriesItem['cost'])
                ->setCellValue('S' . $wildberriesIndex, $wildberriesItem['domestic_shipping'])
                ->setCellValue('T' . $wildberriesIndex, $wildberriesItem['adjustment'])
