    ...
    public function getHomeDepotWarehouseSkuSql($index, $report, $month)
    {
        ...
        foreach ($tiktok as $homedepotItem) {
            ...
            $this->objPHPExcel->setActiveSheetIndex($index)
                ...
                ->setCellValue('V' . $homedepotIndex, $homedepotItem['adCost'])
                ->setCellValue('W' . $homedepotIndex, $homedepotItem['operation_expenses'])
                ->setCellValue('X' . $homedepotIndex, $homedepotItem['operation_factory'])
                ->setCellValue('Y' . $homedepotIndex, $homedepotItem['operation_delivery'])
                ->setCellValue('Z' . $homedepotIndex, $homedepotItem['ddp'])
                ->setCellValue('AA' . $homedepotIndex, $homedepotItem['ddp_percent'])
                ->setCellValue('AB' . $homedepotIndex, $homedepotItem['profit'])
                ->setCellValue('AC' . $homedepotIndex, $homedepotItem['gross_profit_margin'])
                ->setCellValue('AD' . $homedepotIndex, $homedepotItem['ad_percent'])
                ->setCellValue('AE' . $homedepotIndex, $homedepotItem['warehouse_percent'])
                ->setCellValue('AF' . $homedepotIndex, $homedepotItem['tail_percent'])
                ->setCellValue('AG' . $homedepotIndex, $homedepotItem['evaluation_qty'])
                ->setCellValue('AH' . $homedepotIndex, $homedepotItem['evaluation_amount'])
                ->setCellValue('AI' . $homedepotIndex, $homedepotItem['profit_include_evaluation'])
                ->setCellValue('AJ' . $homedepotIndex, $homedepotItem['gross_profit_margin_include_evaluation'])
            ;
        }
    }
